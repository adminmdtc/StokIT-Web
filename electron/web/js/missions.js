...
/* ============================================================
   ข้อมูลภารกิจ กลุ่มงาน และงาน (โครงสร้าง ปีงบประมาณ 64 — อัปเดตจาก 14.xls)
   ============================================================ */
const MISSIONS = [
  {
    id: 'm1',
  ...
  },
  {
    ...
    groups: [
      { id: 'g16', name: 'กลุ่มงานวิชาการพยาบาล', units: [
      ...
      { id: 'g10', name: 'กลุ่มงานการพยาบาลผู้ป่วยใน', units: [
        ...
        'งานการพยาบาลผู้ป่วยในจิตเวช',
        'งานการพยาบาลผู้ป่วยในพิเศษ'
      ]}
    ]
  },
  {
